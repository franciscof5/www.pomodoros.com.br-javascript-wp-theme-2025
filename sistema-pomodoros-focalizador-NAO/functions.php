...
function custom_add_rewrite_rules() {
    add_rewrite_rule('^ranking/?$', 'index.php?custom_page=ranking', 'top');
    add_rewrite_rule('^calendar/?$', 'index.php?custom_page=calendar', 'top');
    add_rewrite_rule('^product/?$', 'index.php?custom_page=product', 'top');
    add_rewrite_rule('^members/?$', 'index.php?custom_page=members', 'top');
    add_rewrite_rule('^app/?$', 'index.php?custom_page=app', 'top');
}
